...
#define GAME_APP_VER "1.3.7rev4.1-PPC"
...
#else
#define GAME_APP_NAME  "ClassiCube 1.3.7rev4.1-PPC"
#define GAME_APP_TITLE "ClassiCube 1.3.7rev4.1-PPC"
#endif
...
#define UPDATES_SERVER  "http://andreiixe.duckdns.org:37910/client"
